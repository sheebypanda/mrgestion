...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { idlocatier: @machine.idlocatier, marque: @machine.marque, modele: @machine.modele, poids: @machine.poids } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { idlocatier: @machine.idlocatier, marque: @machine.marque, modele: @machine.modele, poids: @machine.poids } }
